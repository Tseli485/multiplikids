...
(function () {
  ...
  const STRINGS = {
    fr: {
      ...
      speak_network_error: '⚠️ Impossible de joindre le service de reconnaissance vocale (pare-feu, extension ou réseau bloqué). Vérifie ta connexion.',
    ...
    el: {
      ...
      speak_network_error: '⚠️ Δεν μπορώ να συνδεθώ με την υπηρεσία αναγνώρισης φωνής (τείχος προστασίας, επέκταση ή δίκτυο μπλοκαρισμένο). Έλεγξε τη σύνδεσή σου.',
